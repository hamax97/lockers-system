...
CREATE TABLE `casillero` (
  `idCasillero` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `contenido` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  `usuario_idCodigo` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `usuario` (
  ...
  `celular` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-26 15:31:12
